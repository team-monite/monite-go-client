...
func (c *Client) Create(
	ctx context.Context,
	request *monitegoclient.CreatePaymentLinkRequest,
	opts ...option.RequestOption,
) (*monitegoclient.PublicPaymentLinkResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/payment_links"
	...
	var response *monitegoclient.PublicPaymentLinkResponse
...
func (c *Client) ExpireById(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/payment_links/%v/expire",
		paymentLinkId,
	)
	headers := internal.MergeHeaders(
		c.header.Clone(),
