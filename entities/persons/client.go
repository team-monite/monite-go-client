...
func (c *Client) Get(
...
) (*monitegoclient.PersonsResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *monitegoclient.PersonsResponse
...
func (c *Client) Create(
	ctx context.Context,
	request *entities.PersonRequest,
	opts ...option.RequestOption,
) (*monitegoclient.PersonResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *monitegoclient.PersonResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) UpdateById(
	ctx context.Context,
	personId string,
	request *entities.OptionalPersonRequest,
	opts ...option.RequestOption,
) (*monitegoclient.PersonResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
...
func (c *Client) UploadOnboardingDocuments(
	ctx context.Context,
	personId string,
	request *entities.PersonOnboardingDocumentsPayload,
	opts ...option.RequestOption,
) error {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/persons/%v/onboarding_documents",
		personId,
	)
	headers := internal.MergeHeaders(
		c.header.Clone(),
