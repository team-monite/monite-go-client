...
func (c *Client) Get(
...
) (*monitegoclient.PaymentTermsListResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/payment_terms"
	...
	var response *monitegoclient.PaymentTermsListResponse
...
func (c *Client) Create(
	ctx context.Context,
	request *monitegoclient.PaymentTermsCreatePayload,
	opts ...option.RequestOption,
) (*monitegoclient.PaymentTermsResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *monitegoclient.PaymentTermsResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) UpdateById(
	ctx context.Context,
	paymentTermsId string,
	request *monitegoclient.PaymentTermsUpdatePayload,
	opts ...option.RequestOption,
) (*monitegoclient.PaymentTermsResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
