...
// WithMoniteVersion sets the moniteVersion request header.
func WithMoniteVersion(moniteVersion string) *core.MoniteVersionOption {
	return &core.MoniteVersionOption{
		MoniteVersion: moniteVersion,
	}
}

// WithMoniteEntityId sets the moniteEntityId request header.
//
// The ID of the entity that owns the requested resource.
func WithMoniteEntityId(moniteEntityId *string) *core.MoniteEntityIdOption {
	return &core.MoniteEntityIdOption{
		MoniteEntityId: moniteEntityId,
	}
}
