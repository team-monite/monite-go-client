...
func (r *RequestOptions) ToHeader() http.Header {
	...
	header.Set("x-monite-version", fmt.Sprintf("%v", r.MoniteVersion))
	if r.MoniteEntityId != nil {
		header.Set("x-monite-entity-id", fmt.Sprintf("%v", *r.MoniteEntityId))
	}
	return header
}
...
func (r *RequestOptions) cloneHeader() http.Header {
	...
	headers.Set("User-Agent", "github.com/team-monite/monite-go-client/0.1.0")
	return headers
}
...
// MoniteVersionOption implements the RequestOption interface.
type MoniteVersionOption struct {
	MoniteVersion string
}

func (m *MoniteVersionOption) applyRequestOptions(opts *RequestOptions) {
	opts.MoniteVersion = m.MoniteVersion
}

// MoniteEntityIdOption implements the RequestOption interface.
type MoniteEntityIdOption struct {
	MoniteEntityId *string
}

func (m *MoniteEntityIdOption) applyRequestOptions(opts *RequestOptions) {
	opts.MoniteEntityId = m.MoniteEntityId
}
