...
func (c *Client) Get(
	ctx context.Context,
	request *accounting.PayablesGetRequest,
	opts ...option.RequestOption,
) (*monitegoclient.AccountingPayableList, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/accounting/payables"
	...
	var response *monitegoclient.AccountingPayableList
...
func (c *Client) GetById(
	...
	payableId string,
	opts ...option.RequestOption,
) (*monitegoclient.AccountingPayable, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *monitegoclient.AccountingPayable
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
